...
- `page_size` 唯一允许值为 20、50、100、500，默认仍为 20；不支持 `all`、0、负数或任意区间值。
...
每个 Service 增加表驱动断言：20、50、100、500 成功；0、1、19、21、499、501 及负数返回 `ErrInvalidQuery`。主机必须把旧的“1 到 100 任意值”收紧为同一白名单。
