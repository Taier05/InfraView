...
- 前端：Vitest 39/39、typecheck、build 通过。2026-07-27 的 npm audit 新报告 React Router RSC 模式公告 `GHSA-qwww-vcr4-c8h2`，共 2 个 High；当前 InfraView 为普通 SPA，不使用 RSC Action，但审计事项保持开放，等待兼容的上游修复版本，不执行强制降级。
